...
class FormulaPage extends StatefulWidget {
  const FormulaPage({super.key, required this.constraints});
...
class _FormulaPageState extends State<FormulaPage> {
  ...
  Future<List<Map<String, String>>> getData2() async {
    ...
    if (response.statusCode == 200) {
      var r =null;
      if(type==1){
        r=getData1ByHtml(response.data,1)["data"] as List<Map<String, String>>;
      }else{
        r=getData2ByHtml(response.data,1)["data"] as List<Map<String, String>>;
      }
                ...
                children: [
                  TableRow(
                    children: [
                      ...
                      TableCell(child: Center(child: FittedBox(child: Text("杀本期")))),
                      TableCell(child: Center(child: FittedBox(child: Text("公式7")))),
                    ],
                  )
                ],
              ),
